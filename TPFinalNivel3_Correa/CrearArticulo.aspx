    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanelDDL">
                <ContentTemplate>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:Button runat="server" CssClass="btn btn-success" ID="btnAgregarMarca" Text="Agregar" OnClick="btnAgregarMarca_Click" />
                    ...
                    <div class="mb-3">
                        ...
                        <asp:Button runat="server" CssClass="btn btn-success" ID="btnAgregarCategoria" Text="Agregar" OnClick="btnAgregarCategoria_Click"/>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox CssClass="form-control" runat="server" ID="tbxPrecio" placeholder="1000" />
        ...
        <div class="mb-3">
            ...
            <asp:Button runat="server" CssClass="btn btn-warning" Text="Ocultar Producto" ID="btnOcultar" Visible="false" OnClick="btnOcultar_Click" />
        </div>
    </div>
